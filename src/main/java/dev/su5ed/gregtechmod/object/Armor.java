...
//    CLOAKING_DEVICE(EquipmentSlot.CHEST, GregTechMod.isClassic ? 10000000 : 100000000, 8192, GregTechMod.isClassic ? 4 : 5, 0, 0, false, null, Rarity.EPIC, ArmorPerk.INVISIBILITY_FIELD),
//    LAPOTRONPACK(EquipmentSlot.CHEST, GregTechMod.isClassic ? 10000000 : 100000000, 8192, GregTechMod.isClassic ? 4 : 5, 0, 0, true, GregTechMod.isClassic ? GregTechTags.CRAFTING_10KK_EU_STORE : GregTechTags.CRAFTING_100KK_EU_STORE, Rarity.EPIC),
//    LITHIUM_BATPACK(EquipmentSlot.CHEST, 600000, 128, 1, 0, 0, true, GregTechTags.CRAFTING_600K_EU_STORE, null),
//    ULTIMATE_CHEAT_ARMOR(EquipmentSlot.CHEST, 1000000000, Integer.MAX_VALUE, 1, 10, 100, true, ArmorPerk.values()),
    LIGHT_HELMET(ModArmorMaterial.LIGHT_HELMET, EquipmentSlot.HEAD, 10000, 32, 1, false, ArmorPerk.LAMP, ArmorPerk.SOLARPANEL);
