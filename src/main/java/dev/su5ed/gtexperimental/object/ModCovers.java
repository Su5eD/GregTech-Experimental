...
public final class ModCovers {
    ...
    public static final RegistryObject<CoverType<BlockEntity>> DRAIN = register("drain", CoverCategory.IO, Capabilities.MACHINE_CONTROLLER, DrainCover::new);
    public static final RegistryObject<CoverType<BlockEntity>> ENERGY_ONLY = register("energy_only", CoverCategory.OTHER, Capabilities.MACHINE_CONTROLLER, EnergyOnlyCover::new);
    ...
    public static final RegistryObject<CoverType<BlockEntity>> ITEM_METER = register("item_meter", CoverCategory.METER, Capabilities.MACHINE_CONTROLLER, ItemMeterCover::new);
    ...
    public static final RegistryObject<CoverType<BlockEntity>> LIQUID_METER = register("liquid_meter", CoverCategory.METER, Capabilities.MACHINE_CONTROLLER, LiquidMeterCover::new);
    public static final RegistryObject<CoverType<BlockEntity>> MACHINE_CONTROLLER = register("machine_controller", CoverCategory.CONTROLLER, Capabilities.MACHINE_CONTROLLER, MachineControllerCover::new);
    ...
    public static final RegistryObject<CoverType<BlockEntity>> REDSTONE_CONDUCTOR = register("redstone_conductor", CoverCategory.UTIL, Capabilities.MACHINE_CONTROLLER, RedstoneConductorCover::new);
