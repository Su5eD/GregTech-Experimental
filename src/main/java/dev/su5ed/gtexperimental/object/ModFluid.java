...
public enum ModFluid implements ItemProvider, FluidProvider {
    ...
    NITROCARBON("NC", 1052, 0xFF277474),
    ...
    SODIUM_SULFIDE("NaS", 1860, 0xFF7CA464),
    SULFUR("S", 2000, 0xFFFFCD00),
    SULFURIC_ACID("H2SO4", 1830, 0xFFD9EB05),
    ...
    ModFluid(String description, FluidTextureType type, int density, int tint) {
        ...
        this.tag = GregTechTags.forgeFluidTag(getName());
    }
