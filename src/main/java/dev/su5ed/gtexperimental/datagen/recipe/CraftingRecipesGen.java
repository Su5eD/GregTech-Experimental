...
public final class CraftingRecipesGen implements ModRecipeProvider {
    ...
    public void buildCraftingRecipes(Consumer<FinishedRecipe> finishedRecipeConsumer) {
        // Armor
        shaped(Armor.CLOAKING_DEVICE).define('L', GregTechTags.LARGE_EU_STORE).define('I', GregTechTags.IRIDIUM_ALLOY).define('C', Plate.CHROME.getTag()).pattern("CIC").pattern("ILI").pattern("CIC").unlockedBy("has_large_eu_store", has(GregTechTags.LARGE_EU_STORE)).save(finishedRecipeConsumer, id("armor/cloaking_device"));
        shaped(Armor.LAPOTRONPACK).define('L', GregTechTags.LARGE_EU_STORE).define('C', GregTechTags.CIRCUIT_TIER_7).define('I', GregTechTags.IRIDIUM_ALLOY).define('P', GregTechTags.LAPPACK).define('S', GregTechTags.CRAFTING_SUPERCONDUCTOR).pattern("CLC").pattern("SPS").pattern("CIC").unlockedBy("has_large_eu_store", has(GregTechTags.LARGE_EU_STORE)).save(finishedRecipeConsumer, id("armor/lapotronpack"));
        ...
        shaped(ModCoverItem.ENERGY_FLOW_CIRCUIT, 4).define('L', GregTechTags.MEDIUM_EU_STORE).define('I', GregTechTags.IRIDIUM_ALLOY).define('A', GregTechTags.ADVANCED_CIRCUIT).define('W', Plate.TUNGSTEN.getTag()).pattern("AWA").pattern("LIL").pattern("AWA").unlockedBy("has_medium_eu_store", has(GregTechTags.MEDIUM_EU_STORE)).save(finishedRecipeConsumer, id("component/energy_flow_circuit"));
        toolShaped(Component.IRON_GEAR).define('P', GregTechTags.UNIVERSAL_IRON_PLATE).define('S', GregTechTags.UNIVERSAL_IRON_ROD).define('W', ToolCraftingIngredient.of(GregTechTags.WRENCH, 8)).pattern("SPS").pattern("PWP").pattern("SPS").unlockedBy("has_wrench", has(GregTechTags.WRENCH)).save(finishedRecipeConsumer, id("component/iron_gear"));
        toolShaped(Miscellaneous.IRON_MORTAR).define('S', ItemTags.STONE_BRICKS).define('R', GregTechTags.UNIVERSAL_IRON_INGOT).pattern(" R ").pattern("SRS").pattern("SSS").unlockedBy("has_stone_bricks", has(ItemTags.STONE_BRICKS)).save(finishedRecipeConsumer, id("component/iron_mortar"));
...
//        shaped(ModCoverItem.SOLAR_PANEL_LV).define('S', GregTechTags.CRAFTING_SOLAR_PANEL).define('T', GregTechTags.ADVANCED_CIRCUIT).pattern("SSS").pattern("STS").pattern("SSS").unlockedBy("has_solar_panel", has(GregTechTags.CRAFTING_SOLAR_PANEL)).save(finishedRecipeConsumer, id("component/solar_panel_lv"));
        ...
        // Materials
        shapeless(Dust.INVAR, 3).requires(Ingredient.of(GregTechTags.ANY_IRON_DUST), 2).requires(Dust.NICKEL).unlockedBy("has_nickel_dust", has(Dust.NICKEL)).save(finishedRecipeConsumer, id("material/invar_dust"));
        shapeless(Dust.IRON).requires(Miscellaneous.IRON_MORTAR).requires(GregTechTags.ANY_IRON_INGOT).unlockedBy("has_iron_mortar", has(Miscellaneous.IRON_MORTAR)).save(finishedRecipeConsumer, id("material/iron_dust"));
        shapeless(Smalldust.LEAD, 3).requires(GregTechTags.ANY_IRON_SMALLDUST).requires(Smalldust.NICKEL.getTag()).unlockedBy("has_small_dusts_nickel", has(Smalldust.NICKEL.getTag())).save(finishedRecipeConsumer, id("material/lead_smalldust"));
//        conditionalShapeless(Dust.STEEL).requires(SelectedProfileCondition.REFINED_IRON, tagsIngredient(Dust.IRON.getTag(), GregTechTags.dust("refined_iron"))).requires(SelectedProfileCondition.REGULAR_IRON, Smalldust.IRON.getTag()).requires(Dust.COAL.getTag(), 2).unlockedBy("has_coal_dust", has(Dust.COAL.getTag())).save(finishedRecipeConsumer, id("material/steel_dust"));
        ...
        // Tools
        shaped(File.IRON).define('S', Tags.Items.RODS_WOODEN).define('P', GregTechTags.UNIVERSAL_IRON_PLATE).pattern("P").pattern("P").pattern("S").unlockedBy("has_rods_wooden", has(Tags.Items.RODS_WOODEN)).save(finishedRecipeConsumer, id("tool/iron_file"));
        shaped(File.STEEL).define('S', GregTechTags.UNIVERSAL_IRON_ROD).define('P', Plate.STEEL.getTag()).pattern("P").pattern("P").pattern("S").unlockedBy("has_steel_plate", has(Plate.STEEL.getTag())).save(finishedRecipeConsumer, id("tool/steel_file"));
        shaped(File.BRONZE).define('S', Tags.Items.RODS_WOODEN).define('P', Plate.BRONZE.getTag()).pattern("P").pattern("P").pattern("S").unlockedBy("has_bronze_plate", has(Plate.BRONZE.getTag())).save(finishedRecipeConsumer, id("tool/bronze_file"));
        shaped(File.TUNGSTEN_STEEL).define('S', Rod.STEEL.getTag()).define('P', Plate.TUNGSTEN_STEEL.getTag()).pattern("P").pattern("P").pattern("S").unlockedBy("has_tungsten_steel_plate", has(Plate.TUNGSTEN_STEEL.getTag())).save(finishedRecipeConsumer, id("tool/tungsten_steel_file"));
        shaped(Hammer.IRON).define('S', Tags.Items.RODS_WOODEN).define('R', GregTechTags.UNIVERSAL_IRON_INGOT).pattern("RRR").pattern("RRR").pattern(" S ").unlockedBy("has_iron_ingot", has(GregTechTags.UNIVERSAL_IRON_INGOT)).save(finishedRecipeConsumer, id("tool/iron_hammer"));
        shaped(Hammer.BRONZE).define('S', Tags.Items.RODS_WOODEN).define('R', GregTechTags.ingot("bronze")).pattern("RRR").pattern("RRR").pattern(" S ").unlockedBy("has_bronze_ingot", has(GregTechTags.ingot("bronze"))).save(finishedRecipeConsumer, id("tool/bronze_hammer"));
        shaped(Hammer.STEEL).define('S', GregTechTags.UNIVERSAL_IRON_ROD).define('R', Ingot.STEEL.getTag()).pattern("RRR").pattern("RRR").pattern(" S ").unlockedBy("has_steel_ingot", has(Ingot.STEEL.getTag())).save(finishedRecipeConsumer, id("tool/steel_hammer"));
        shaped(Hammer.TUNGSTEN_STEEL).define('S', Rod.STEEL.getTag()).define('R', Ingot.TUNGSTEN_STEEL.getTag()).pattern("RRR").pattern("RRR").pattern(" S ").unlockedBy("has_tungsten_steel_ingot", has(Ingot.TUNGSTEN_STEEL.getTag())).save(finishedRecipeConsumer, id("tool/tungsten_steel_hammer"));
        shaped(Saw.IRON).define('S', Tags.Items.RODS_WOODEN).define('P', GregTechTags.UNIVERSAL_IRON_PLATE).define('F', GregTechTags.FILE).define('H', GregTechTags.HARD_HAMMER).pattern("SSS").pattern("PPS").pattern("FH ").unlockedBy("has_hard_hammer", has(GregTechTags.HARD_HAMMER)).save(finishedRecipeConsumer, id("tool/iron_saw"));
        shaped(Saw.STEEL).define('S', GregTechTags.UNIVERSAL_IRON_ROD).define('P', Plate.STEEL.getTag()).define('F', GregTechTags.FILE).define('H', GregTechTags.HARD_HAMMER).pattern("SSS").pattern("PPS").pattern("FH ").unlockedBy("has_hard_hammer", has(GregTechTags.HARD_HAMMER)).save(finishedRecipeConsumer, id("tool/steel_saw"));
        shaped(Saw.BRONZE).define('S', Tags.Items.RODS_WOODEN).define('P', Plate.BRONZE.getTag()).define('F', GregTechTags.FILE).define('H', GregTechTags.HARD_HAMMER).pattern("SSS").pattern("PPS").pattern("FH ").unlockedBy("has_hard_hammer", has(GregTechTags.HARD_HAMMER)).save(finishedRecipeConsumer, id("tool/bronze_saw"));
        shaped(Saw.TUNGSTEN_STEEL).define('S', Rod.STEEL.getTag()).define('P', Plate.TUNGSTEN_STEEL.getTag()).define('F', GregTechTags.FILE).define('H', GregTechTags.HARD_HAMMER).pattern("SSS").pattern("PPS").pattern("FH ").unlockedBy("has_hard_hammer", has(GregTechTags.HARD_HAMMER)).save(finishedRecipeConsumer, id("tool/tunsten_steel_saw"));
        shaped(Wrench.IRON).define('I', GregTechTags.UNIVERSAL_IRON_INGOT).pattern("I I").pattern("III").pattern(" I ").unlockedBy("has_iron_ingot", has(GregTechTags.UNIVERSAL_IRON_INGOT)).save(finishedRecipeConsumer, id("tool/iron_wrench"));
        conditionalShaped(Wrench.BRONZE).define('B', GregTechTags.ingot("bronze")).pattern("B B").pattern("BBB").pattern(" B ").unlockedBy("has_bronze_ingot", has(GregTechTags.ingot("bronze"))).addCondition(NOT_IC2_LOADED).save(finishedRecipeConsumer, id("tool/bronze_wrench"));
        shaped(Wrench.STEEL).define('S', Ingot.STEEL.getTag()).pattern("S S").pattern("SSS").pattern(" S ").unlockedBy("has_steel_ingot", has(Ingot.STEEL.getTag())).save(finishedRecipeConsumer, id("tool/steel_wrench"));
        shaped(Wrench.TUNGSTEN_STEEL).define('T', Ingot.TUNGSTEN_STEEL.getTag()).pattern("T T").pattern("TTT").pattern(" T ").unlockedBy("has_tungsten_steel", has(Ingot.TUNGSTEN_STEEL.getTag())).save(finishedRecipeConsumer, id("tool/tungsten_steel_wrench"));
        shaped(JackHammer.BRONZE).define('B', GregTechTags.RE_BATTERY).define('C', GregTechTags.CIRCUIT).define('S', Rod.BRONZE.getTag()).define('I', GregTechTags.ingot("bronze")).pattern("SBS").pattern(" C ").pattern(" I ").unlockedBy("has_re_battery", has(GregTechTags.RE_BATTERY)).save(finishedRecipeConsumer, id("tool/bronze_jack_hammer"));
        shaped(JackHammer.STEEL).define('B', GregTechTags.RE_BATTERY).define('C', GregTechTags.ADVANCED_CIRCUIT).define('S', Rod.STEEL.getTag()).define('I', Ingot.STEEL.getTag()).pattern("SBS").pattern(" C ").pattern(" I ").unlockedBy("has_re_battery", has(GregTechTags.RE_BATTERY)).save(finishedRecipeConsumer, id("tool/steel_jack_hammer"));
        shaped(JackHammer.DIAMOND).define('B', GregTechTags.CRAFTING_100K_EU_STORE).define('C', GregTechTags.ADVANCED_CIRCUIT).define('S', tagsIngredient(Rod.TITANIUM.getTag(), Rod.TUNGSTEN_STEEL.getTag())).define('D', Dust.DIAMOND.getTag()).pattern("SBS").pattern(" C ").pattern(" D ").unlockedBy("has_100k_eu_store", has(GregTechTags.CRAFTING_100K_EU_STORE)).save(finishedRecipeConsumer, id("tool/diamond_jack_hammer"));
        shaped(Tool.ADVANCED_DRILL).define('C', GregTechTags.CIRCUIT_TIER_6).define('B', GregTechTags.CRAFTING_LI_BATTERY).define('S', Plate.TUNGSTEN_STEEL.getTag()).define('D', Tags.Items.GEMS_DIAMOND).pattern("DDD").pattern("SCS").pattern("SBS").unlockedBy("has_circuit_tier_6", has(GregTechTags.CIRCUIT_TIER_6)).save(finishedRecipeConsumer, id("tool/advanced_drill"));
        shaped(Tool.ADVANCED_SAW).define('C', GregTechTags.ADVANCED_CIRCUIT).define('B', GregTechTags.CRAFTING_LI_BATTERY).define('S', Plate.TUNGSTEN_STEEL.getTag()).pattern(" SS").pattern("SCS").pattern("BS ").unlockedBy("has_advanced_circuit", has(GregTechTags.ADVANCED_CIRCUIT)).save(finishedRecipeConsumer, id("tool/advanced_saw"));
        shaped(Tool.ADVANCED_WRENCH).define('C', GregTechTags.ADVANCED_CIRCUIT).define('B', GregTechTags.CRAFTING_LI_BATTERY).define('T', Plate.TUNGSTEN_STEEL.getTag()).pattern("T T").pattern("TCT").pattern(" B ").unlockedBy("has_advanced_circuit", has(GregTechTags.ADVANCED_CIRCUIT)).save(finishedRecipeConsumer, id("tool/advanced_wrench"));
        shaped(Tool.CROWBAR).define('I', GregTechTags.UNIVERSAL_IRON_INGOT).define('B', Tags.Items.DYES_BLUE).pattern(" BI").pattern("BIB").pattern("IB ").unlockedBy("has_iron_ingot", has(GregTechTags.UNIVERSAL_IRON_INGOT)).save(finishedRecipeConsumer, id("tool/crowbar"));
        shaped(Tool.DESTRUCTORPACK).define('A', GregTechTags.ADVANCED_CIRCUIT).define('R', tagsIngredient(GregTechTags.UNIVERSAL_IRON_PLATE, Plate.ALUMINIUM.getTag())).define('L', Items.LAVA_BUCKET).pattern("ARA").pattern("RLR").pattern("ARA").unlockedBy("has_advanced_circuit", has(GregTechTags.ADVANCED_CIRCUIT)).save(finishedRecipeConsumer, id("tool/destructorpack"));
        shaped(Tool.RUBBER_HAMMER).define('S', Tags.Items.RODS_WOODEN).define('R', GregTechTags.RUBBER).pattern("RRR").pattern("RRR").pattern(" S ").unlockedBy("has_rubber", has(GregTechTags.RUBBER)).save(finishedRecipeConsumer, id("tool/rubber_hammer"));
        shaped(Tool.LAPOTRONIC_ENERGY_ORB).define('L', GregTechTags.MEDIUM_EU_STORE).define('I', GregTechTags.IRIDIUM_ALLOY).pattern("LLL").pattern("LIL").pattern("LLL").unlockedBy("has_medium_eu_store", has(GregTechTags.MEDIUM_EU_STORE)).save(finishedRecipeConsumer, id("tool/lapotronic_energy_orb"));
        shaped(Tool.SCREWDRIVER).define('I', GregTechTags.UNIVERSAL_IRON_ROD).define('S', Tags.Items.RODS_WOODEN).pattern("I  ").pattern(" I ").pattern("  S").unlockedBy("has_iron_rod", has(GregTechTags.UNIVERSAL_IRON_ROD)).save(finishedRecipeConsumer, id("tool/screwdriver"));
        shaped(Tool.SOLDERING_TOOL).define('C', GregTechTags.CIRCUIT).define('B', GregTechTags.RE_BATTERY).define('R', GregTechTags.UNIVERSAL_IRON_INGOT).pattern("R").pattern("C").pattern("B").unlockedBy("has_circuit", has(GregTechTags.CIRCUIT)).save(finishedRecipeConsumer, id("tool/soldering_tool"));
        shaped(Tool.TESLA_STAFF).define('L', GregTechTags.LARGE_EU_STORE).define('S', GregTechTags.CRAFTING_SUPERCONDUCTOR).define('I', GregTechTags.IRIDIUM_ALLOY).pattern("LS ").pattern("SI ").pattern("  I").unlockedBy("has_iridium_alloy", has(GregTechTags.IRIDIUM_ALLOY)).save(finishedRecipeConsumer, id("tool/tesla_staff"));
        shaped(Tool.ROCK_CUTTER).define('B', GregTechTags.RE_BATTERY).define('C', GregTechTags.CIRCUIT).define('P', Plate.TITANIUM.getTag()).define('S', Rod.TITANIUM.getTag()).define('D', Dust.DIAMOND.getTag()).pattern("DS ").pattern("DP ").pattern("DCB").unlockedBy("has_re_battery", has(GregTechTags.RE_BATTERY)).save(finishedRecipeConsumer, id("tool/rock_cutter"));
        shaped(Tool.ROCK_CUTTER).define('B', GregTechTags.RE_BATTERY).define('C', GregTechTags.CIRCUIT).define('P', Plate.TUNGSTEN_STEEL.getTag()).define('S', Rod.TUNGSTEN_STEEL.getTag()).define('D', Dust.DIAMOND.getTag()).pattern("DS ").pattern("DP ").pattern("DCB").unlockedBy("has_re_battery", has(GregTechTags.RE_BATTERY)).save(finishedRecipeConsumer, id("tool/rock_cutter_tungsten_steel"));
