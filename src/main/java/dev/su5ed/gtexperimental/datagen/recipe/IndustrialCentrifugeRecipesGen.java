...
public final class IndustrialCentrifugeRecipesGen implements ModRecipeProvider {
    ...
    public void buildCraftingRecipes(Consumer<FinishedRecipe> finishedRecipeConsumer) {
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.dust("copper")), Smalldust.GOLD.getItemStack(), Smalldust.NICKEL.getItemStack(), 2400).build(finishedRecipeConsumer, id("copper_dust"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.dust("gold"), 3), Smalldust.COPPER.getItemStack(), Smalldust.NICKEL.getItemStack(), 2400).build(finishedRecipeConsumer, id("gold_dust"));
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.dust("iron"), 2), Smalldust.TIN.getItemStack(), Smalldust.NICKEL.getItemStack(), 1500).build(finishedRecipeConsumer, id("iron_dust"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.dust("tin"), 2), Smalldust.ZINC.getItemStack(), Smalldust.IRON.getItemStack(), 2100).build(finishedRecipeConsumer, id("tin_dust"));
