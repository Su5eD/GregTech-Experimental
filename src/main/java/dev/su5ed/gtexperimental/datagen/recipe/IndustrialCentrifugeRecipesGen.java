...
public final class IndustrialCentrifugeRecipesGen implements ModRecipeProvider {
    ...
    public void buildCraftingRecipes(Consumer<FinishedRecipe> finishedRecipeConsumer) {
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Tags.Items.DUSTS_REDSTONE, 10), ModFluid.SILICON.getBuckets(1), Dust.PYRITE.getItemStack(5), Dust.RUBY.getItemStack(), ModFluid.MERCURY.getItemStack(3), 7000)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.dust("quicksilver")), ModFluid.MERCURY.getBuckets(1), 100)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Dust.ENDSTONE.getTag(), 16), ModFluid.HELIUM3.getBuckets(1), ModFluid.WOLFRAMIUM.getBuckets(1), Smalldust.TUNGSTEN.getItemStack(), new ItemStack(Items.SAND, 16), 4800)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.ofFluid(ModFluid.HYDROGEN.getTag(), buckets(4)), ModFluid.DEUTERIUM.getBuckets(1), 3000)
            .build(finishedRecipeConsumer, id("hydrogen"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.ofFluid(ModFluid.HELIUM.getTag(), buckets(16)), ModFluid.HELIUM3.getBuckets(1), 10000)
            .build(finishedRecipeConsumer, id("helium"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.ofFluid(ModFluid.HELIUM3.getTag(), buckets(4)), ModFluid.DEUTERIUM.getBuckets(1), 3000)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.OIL_SAND, 2), ModFluid.OIL.getBuckets(1), new ItemStack(Items.SAND), 1000)
...
//            .build(finishedRecipeConsumer, id("ice_cell"));
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Items.ENCHANTED_GOLDEN_APPLE), ModFluid.METHANE.getBuckets(2), new ItemStack(Items.GOLD_INGOT, 64), 10000)
            .build(finishedRecipeConsumer, id("enchanted_golden_apple"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Items.GOLDEN_APPLE, Items.GOLDEN_CARROT), ModFluid.METHANE.getBuckets(1), new ItemStack(Items.GOLD_NUGGET, 6), 10000)
            .build(finishedRecipeConsumer, id("golden_apple"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(8, Items.GLISTERING_MELON_SLICE, Items.CAKE), ModFluid.METHANE.getBuckets(1), new ItemStack(Items.GOLD_NUGGET, 6), 10000)
            .build(finishedRecipeConsumer, id("glistering_melon_slice"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(32, Items.APPLE, Items.SPIDER_EYE, Items.NETHER_WART), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("apple"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.RAW_FOOD, 12), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("raw_food"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.COOKED_FOOD, 16), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("cooked_food"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(64, Items.MELON, Items.COOKIE, Items.BREAD), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("melon"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(16, Items.PUMPKIN, Items.ROTTEN_FLESH, Items.CARROT, Items.POTATO, Items.MUSHROOM_STEW), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("pumpkin"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(12, Items.POISONOUS_POTATO, Items.BROWN_MUSHROOM_BLOCK, Items.RED_MUSHROOM_BLOCK), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("poisonous_potato"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Items.BAKED_POTATO, 24), ModFluid.METHANE.getBuckets(1), 5000)
            .build(finishedRecipeConsumer, id("baked_potato"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.ofFluid(ModFluid.DEUTERIUM.getTag(), buckets(4)), ModFluid.TRITIUM.getBuckets(1), 3000)
    ...
    private void buildOtherModRecipes(Consumer<FinishedRecipe> finishedRecipeConsumer) {
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Tags.Items.DUSTS_GLOWSTONE, 16), new ItemStack(Items.REDSTONE, 8), new ItemStack(Ic2Items.GOLD_DUST, 8), ModFluid.HELIUM.getBuckets(1), 25000)
            .addConditions(IC2_LOADED)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Items.SOUL_SAND, 16), ModFluid.OIL.getBuckets(1), Dust.SALTPETER.getItemStack(4), new ItemStack(Ic2Items.COAL_DUST), new ItemStack(Items.SAND, 10), 2500)
            .addConditions(IC2_LOADED)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Tags.Items.DUSTS_GLOWSTONE, 16), new ItemStack(Items.REDSTONE, 8), new ItemStack(FTBICItems.getResourceFromType(ResourceElements.GOLD, ResourceType.DUST).orElseThrow().get(), 8), ModFluid.HELIUM.getBuckets(1), 25000)
            .addConditions(NOT_IC2_LOADED, FTBIC_LOADED)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(GregTechTags.material("logs", "rubber"), 16), new ItemStack(MyrtreesItems.LATEX.get(), 8), new ItemStack(Items.VINE, 6), ModFluid.METHANE.getBuckets(1), ModFluid.CARBON.getBuckets(4), 5000)
            .addConditions(NOT_IC2_LOADED, MYRTREES_LOADED)
            .build(finishedRecipeConsumer, id("myrtrees/rubber_log"));
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(Items.SOUL_SAND, 16), ModFluid.OIL.getBuckets(1), Dust.SALTPETER.getItemStack(4), new ItemStack(FTBICItems.getResourceFromType(ResourceElements.COAL, ResourceType.DUST).orElseThrow().get()), new ItemStack(Items.SAND, 10), 2500)
            .addConditions(NOT_IC2_LOADED, FTBIC_LOADED)
        ...
        industrialCentrifuge(ModRecipeIngredientTypes.HYBRID.of(MyrtreesItems.LATEX.get(), 4), new ItemStack(FTBICItems.RUBBER.item.get(), 14), new ItemStack(Items.VINE), new ItemStack(Items.GRASS), 1300)
            .addConditions(FTBIC_LOADED, MYRTREES_LOADED)
