...
//            .build(finishedRecipeConsumer, id("re_battery"));
        ...
        industrialElectrolyzer(ModRecipeIngredientTypes.HYBRID.ofFluidBuckets(ModFluid.SULFURIC_ACID.getTag(), 7), ModFluid.HYDROGEN.getBuckets(2), ModFluid.SULFUR.getBuckets(1), new FluidStack(Ic2Fluids.AIR.still, buckets(2)), 40, 100)
            .addConditions(IC2_LOADED)
            .build(finishedRecipeConsumer, IndustrialElectrolyzerRecipesGen.id("sulfuric_acid"));
        industrialElectrolyzer(ModRecipeIngredientTypes.HYBRID.ofFluidBuckets(FluidTags.WATER, 6), ModFluid.HYDROGEN.getBuckets(4), new FluidStack(Ic2Fluids.AIR.still, buckets(1)), 775, 120)
            .addConditions(IC2_LOADED)
        ...
        // Pulverizer
        pulverizer(ModRecipeIngredientTypes.ITEM.of(GregTechTags.gem("apatite")), new ItemStack(Ic2Items.FERTILIZER, 4), Dust.PHOSPHORUS.getItemStack(), 50)
            .addConditions(IC2_LOADED)
            .build(finishedRecipeConsumer, pulverizerId("gems_apatite"));
        ...
        conditionalShaped(Ic2Items.RE_BATTERY, 2).define('S', VanillaFluidIngredient.ofFluid(ModFluid.SULFURIC_ACID.getTag())).define('L', Dust.LEAD.getTag()).define('C', GregTechTags.INSULATED_COPPER_CABLE).define('T', Plate.TIN.getTag()).pattern(" C ").pattern("TLT").pattern("TST").unlockedBy("has_insulated_copper_cable", has(GregTechTags.INSULATED_COPPER_CABLE)).addCondition(IC2_LOADED).save(finishedRecipeConsumer, shapedId("component/re_battery_sulfur"));
        ...
        conditionalShaped(Ic2Items.RE_BATTERY, 3).define('S', VanillaFluidIngredient.ofFluid(ModFluid.SULFURIC_ACID.getTag())).define('L', Dust.LEAD.getTag()).define('C', GregTechTags.INSULATED_COPPER_CABLE).define('T', Plate.BATTERY_ALLOY.getTag()).pattern(" C ").pattern("TLT").pattern("TST").unlockedBy("has_insulated_copper_cable", has(GregTechTags.INSULATED_COPPER_CABLE)).addCondition(IC2_LOADED).save(finishedRecipeConsumer, shapedId("component/re_battery_sulfur_alloy"));
        conditionalShaped(Ic2Items.SINGLE_USE_BATTERY, 32).define('Q', VanillaFluidIngredient.ofFluid(ModFluid.MERCURY.getTag())).define('R', Tags.Items.DUSTS_REDSTONE).define('C', GregTechTags.INSULATED_COPPER_CABLE).pattern("C").pattern("Q").pattern("R").unlockedBy("has_insulated_copper_cable", has(GregTechTags.INSULATED_COPPER_CABLE)).addCondition(IC2_LOADED).save(finishedRecipeConsumer, shapedId("component/single_use_battery"));
        conditionalShaped(Ic2Items.SINGLE_USE_BATTERY, 32).define('S', VanillaFluidIngredient.ofFluid(ModFluid.SULFURIC_ACID.getTag())).define('R', Dust.LEAD.getTag()).define('C', GregTechTags.INSULATED_COPPER_CABLE).pattern("C").pattern("S").pattern("R").unlockedBy("has_insulated_copper_cable", has(GregTechTags.INSULATED_COPPER_CABLE)).addCondition(IC2_LOADED).save(finishedRecipeConsumer, shapedId("component/single_use_battery_sulfur"));
...
//        conditionalShaped(Ic2Items.MINING_LASER).define('C', GregTechTags.ADVANCED_CIRCUIT).define('H', NuclearCoolantPack.HELIUM_360K.getTag()).define('R', Miscellaneous.RUBY.getTag()).define('T', Plate.TITANIUM.getTag()).define(SelectedProfileCondition.CLASSIC, 'E', GregTechTags.CRAFTING_100K_EU_STORE).define(SelectedProfileCondition.EXPERIMENTAL, 'E', GregTechTags.CRAFTING_1KK_EU_STORE).define('A', GregTechTags.ADVANCED_ALLOY).pattern("RHE").pattern("TTC").pattern(" AA").addCondition(IC2_LOADED).save(finishedRecipeConsumer, new ResourceLocation(ModHandler.IC2_MODID, "shaped/mining_laser"));
        ...
        conditionalShapeless(Ic2Items.FERTILIZER, 3).requires(Ic2Items.FERTILIZER).requires(Dust.SULFUR.getTag()).requires(VanillaFluidIngredient.ofFluid(ModFluid.CALCIUM.getTag())).unlockedBy("has_sulfur_dust", has(Dust.SULFUR.getTag())).addCondition(IC2_LOADED).save(finishedRecipeConsumer, shapelessId("fertilizer_sulfur_dust"));
        conditionalShapeless(Ic2Items.FERTILIZER, 3).requires(Ic2Items.FERTILIZER).requires(VanillaFluidIngredient.ofFluid(ModFluid.SULFUR.getTag())).requires(VanillaFluidIngredient.ofFluid(ModFluid.CALCIUM.getTag())).unlockedBy("has_sulfur_fluid", hasFluid(ModFluid.SULFUR.getTag())).addCondition(IC2_LOADED).save(finishedRecipeConsumer, shapelessId("fertilizer_sulfur_fluid"));
