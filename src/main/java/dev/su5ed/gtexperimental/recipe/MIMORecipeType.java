...
public class MIMORecipeType<R extends MIMORecipe> extends BaseRecipeTypeImpl<R, ListRecipeIngredientType<List<RecipeIngredient<ItemStack>>, ItemStack>, List<RecipeIngredient<ItemStack>>, List<ItemStack>> {
