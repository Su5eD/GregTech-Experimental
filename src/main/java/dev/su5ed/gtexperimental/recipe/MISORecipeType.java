...
public class MISORecipeType<R extends MISORecipe<IN, OUT>, IN, OUT> extends ModRecipeType<R, ListRecipeIngredientType<List<RecipeIngredient<IN>>, IN>, List<? extends RecipeIngredient<IN>>, OUT> {
