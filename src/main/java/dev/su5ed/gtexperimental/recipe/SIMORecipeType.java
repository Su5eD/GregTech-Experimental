...
public class SIMORecipeType<R extends SIMORecipe<IN, OUT>, IN, OUT> extends BaseRecipeTypeImpl<R, RecipeIngredientType<? extends RecipeIngredient<IN>, IN>, RecipeIngredient<IN>, OUT> {
