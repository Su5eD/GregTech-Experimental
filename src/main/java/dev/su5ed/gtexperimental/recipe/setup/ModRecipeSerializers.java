...
public final class ModRecipeSerializers {
    ...
    public static final RegistryObject<RecipeSerializer<SIMORecipe<Either<ItemStack, FluidStack>, Either<ItemStack, FluidStack>>>> INDUSTRIAL_ELECTROLYZER = register("industrial_electrolyzer", ModRecipeTypes.INDUSTRIAL_ELECTROLYZER);
    public static final RegistryObject<RecipeSerializer<SIMORecipe<ItemStack, ItemStack>>> LATHE = register("lathe", ModRecipeTypes.LATHE);
