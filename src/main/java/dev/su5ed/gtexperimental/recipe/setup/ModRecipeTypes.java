...
public final class ModRecipeTypes {
    ...
    public static final RegistryObject<SIMORecipeType<SIMORecipe<Either<ItemStack, FluidStack>, Either<ItemStack, FluidStack>>, Either<ItemStack, FluidStack>, Either<ItemStack, FluidStack>>> INDUSTRIAL_ELECTROLYZER = ModRecipeTypes.<SIMORecipe<Either<ItemStack, FluidStack>, Either<ItemStack, FluidStack>>, Either<ItemStack, FluidStack>, Either<ItemStack, FluidStack>>simo("industrial_electrolyzer", ModRecipeIngredientTypes.HYBRID, ModRecipeOutputTypes.HYBRID, 4, SIMORecipe::industrialElectrolyzer);
    public static final RegistryObject<SIMORecipeType<SIMORecipe<ItemStack, ItemStack>, ItemStack, ItemStack>> LATHE = ModRecipeTypes.<SIMORecipe<ItemStack, ItemStack>, ItemStack, ItemStack>simo("lathe", ModRecipeIngredientTypes.ITEM, ModRecipeOutputTypes.ITEM, 2, SIMORecipe::lathe);
