...
public final class ModRecipeManagers {
    ...
    public static final RecipeManager<SIMORecipe<Either<ItemStack, FluidStack>, Either<ItemStack, FluidStack>>, Either<ItemStack, FluidStack>> INDUSTRIAL_ELECTROLYZER = create(ModRecipeTypes.INDUSTRIAL_ELECTROLYZER);
    public static final RecipeManager<SIMORecipe<ItemStack, ItemStack>, ItemStack> LATHE = create(ModRecipeTypes.LATHE);
