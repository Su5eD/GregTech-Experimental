...
public class IndustrialCentrifugeRecipe extends SIMORecipe<Either<ItemStack, FluidStack>, List<Either<ItemStack, FluidStack>>> {
    ...
    public IndustrialCentrifugeRecipe(ResourceLocation id, RecipeIngredient<Either<ItemStack, FluidStack>> input, List<Either<ItemStack, FluidStack>> output, RecipePropertyMap properties) {
        super(ModRecipeTypes.INDUSTRIAL_CENTRIFUGE.get(), ModRecipeSerializers.INDUSTRIAL_CENTRIFUGE.get(), id, input, output, properties.withTransient(b -> b.energyCost(5)));
    }
}
