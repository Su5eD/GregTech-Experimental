...
public class SimpleMachineMenu extends BlockEntityMenu<SimpleMachineBlockEntity> {
    ...
    public static SimpleMachineMenu lathe(int containerId, BlockPos pos, Inventory playerInventory, Player player) {
        return new SimpleMachineMenu(ModMenus.LATHE.get(), GTBlockEntity.LATHE.getType(), containerId, pos, playerInventory, player);
    }

    public static SimpleMachineMenu universalMacerator(int containerId, BlockPos pos, Inventory playerInventory, Player player) {
    ...
    public static SimpleMachineMenu printer(int containerId, BlockPos pos, Inventory playerInventory, Player player) {
        return new SimpleMachineMenu(ModMenus.PRINTER.get(), GTBlockEntity.PRINTER.getType(), containerId, pos, playerInventory, player);
    }
