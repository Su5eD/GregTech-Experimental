...
public enum GregTechTEBlock implements ITeBlock, ITeBlock.ITeBlockCreativeRegisterer, ITeBlockSpecialItem {
    ...
    GAS_TURBINE(TileEntityGasTurbine.class, 30, false, Util.horizontalFacings, true, HarvestTool.Wrench, DefaultDrop.None, 10, 30,EnumRarity.COMMON, IC2Material.MACHINE, true),
    PLASMA_GENERATOR(TileEntityPlasmaGenerator.class, 31, true, Util.allFacings, true, HarvestTool.Wrench, DefaultDrop.None, 10, 30,EnumRarity.COMMON, IC2Material.MACHINE, true);
