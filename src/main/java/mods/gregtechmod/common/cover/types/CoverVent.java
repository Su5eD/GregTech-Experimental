...
public class CoverVent extends CoverGeneric {
    ...
    public enum VentType {
        NORMAL(GregtechMod.MODID, VentType.coverLoc + "machine_vent_rotating"),
        SPREAD(GregtechMod.MODID, VentType.coverLoc + "adv_machine_vent"),
        ADVANCED(GregtechMod.MODID, VentType.coverLoc + "adv_machine_vent_rotating");

        private final String domain;
        private final String path;
        private static final String coverLoc = "blocks/covers/";
