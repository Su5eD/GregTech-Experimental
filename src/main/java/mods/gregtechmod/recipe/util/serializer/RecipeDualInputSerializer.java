...
public class RecipeDualInputSerializer extends RecipeSerializer<IGtMachineRecipe<List<IRecipeIngredient>, ItemStack>, List<IRecipeIngredient>, ItemStack> {
    ...
    @Override
    public void serializeExtraFields(IGtMachineRecipe<List<IRecipeIngredient>, ItemStack> recipe, JsonGenerator gen, SerializerProvider serializers) {}
}
