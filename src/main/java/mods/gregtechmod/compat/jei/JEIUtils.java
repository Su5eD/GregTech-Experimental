...
public class JEIUtils {
    ...
    public static void drawInfo(Minecraft minecraft, IMachineRecipe<?, ?> recipe, int yOffset, boolean showEnergyCost) {
        ...
        minecraft.fontRenderer.drawString(GtUtil.translate("jei.energy", GtUtil.formatNumber(duration * energyCost)), 2, yOffset + 60, GuiColors.BLACK, false);
        minecraft.fontRenderer.drawString(GtUtil.translate("jei.time", GtUtil.formatNumber(duration / 20)), 2,yOffset + 70, GuiColors.BLACK, false);
        if (showEnergyCost) minecraft.fontRenderer.drawString(GtUtil.translate("jei.max_energy", GtUtil.formatNumber(energyCost)), 2,yOffset + 80, GuiColors.BLACK, false);
    }
