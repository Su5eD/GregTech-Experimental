...
@ZenClass("mods.gregtechmod.Centrifuge")
@ZenRegister
public class CentrifugeRecipes {
    ...
    public static void addRecipe(IIngredient input, IItemStack[] outputs, int cells, int duration, @Optional CTCellType cellType) {
        ...
        IRecipeCellular cellular = GregTechAPI.getRecipeFactory().makeCentrifugeRecipe(ingredient, outputStacks, cells, duration, cellType != null ? cellType.getCellType() : CellType.CELL);
        CraftTweakerAPI.apply(new AddRecipeAction<>(GtRecipes.industrialCentrifuge, cellular));
    }
