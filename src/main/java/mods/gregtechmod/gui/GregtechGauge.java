...
public enum GregtechGauge implements Gauge.IGaugeStyle {
    ...
    MACERATING(new Gauge.GaugePropertyBuilder(176, 0, 20, 17, Gauge.GaugePropertyBuilder.GaugeOrientation.Right).withTexture(GuiAutoMacerator.TEXTURE).withSmooth(false).build());
